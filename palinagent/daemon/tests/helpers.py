...
def _write_header(output):
    ...
    output.write('<agent\n')
    output.write('xmlns="urn:proactive:agent:0.90:linux"\n')
    output.write('xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"\n')
    output.write('xsi:schemaLocation="urn:proactive:agent:0.90:linux http://www.activeeon.com/public_content/schemas/proactive/agent/0.90/agent-linux.xsd">\n')
